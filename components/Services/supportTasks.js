      ...
      <section className="sectionContainer">
        <div className="container">
          <div className="supportContainer">
            <div className="supportcontainer3">
              <div className="supportContainer4">
                <div className="supportContainer5">
                  <div className="supportContainer6">
                  <img className="" style={{maxWidth:"none"}}
                src="/images/services-details/service-details11.jpg"
                alt="image" width={500} height={500}/>
                  </div>
                  <div className="supportContainer6">
                  <img className="" style={{maxWidth:"none"}}
                src="/images/services-details/serice-details12.jpg"
                alt="image" width={500} height={640} />
                  </div>
                </div>
                <div className="supportContainer5">
                  <div className="relative z-10 my-4">
                    {/* <img
                      src="https://i.ibb.co/9640y7nYCD/image-3.jpg"
                      alt=""
            ...
            <div className="supportContainer2">
              <div className="supportedContainer7">
                <span className="block mb-2 text-lg font-semibold text-primary">
                  
                </span>
                <h2 className="mb-8 text-3xl font-bold text-dark sm:text-4xl">
                  Supported with Daily Tasks{" "}
                </h2>
